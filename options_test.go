...
func TestOpts(t *testing.T) {
	cases := []struct {
		...
		{"--log-target stdout --log-target stderr", Options{
		...
		{"--log-stacktrace-level debug", Options{
			OutputPaths:        []string{defaultOutputPath},
			ErrorOutputPaths:   []string{defaultErrorOutputPath},
			outputLevels:       DefaultScopeName + ":" + levelToString[defaultOutputLevel],
		...
		{"--log-stacktrace-level default:debug", Options{
			OutputPaths:        []string{defaultOutputPath},
			ErrorOutputPaths:   []string{defaultErrorOutputPath},
			outputLevels:       DefaultScopeName + ":" + levelToString[defaultOutputLevel],
		...
		{"--log-stacktrace-level info", Options{
			OutputPaths:        []string{defaultOutputPath},
			ErrorOutputPaths:   []string{defaultErrorOutputPath},
			outputLevels:       DefaultScopeName + ":" + levelToString[defaultOutputLevel],
		...
		{"--log-stacktrace-level default:info", Options{
			OutputPaths:        []string{defaultOutputPath},
			ErrorOutputPaths:   []string{defaultErrorOutputPath},
			outputLevels:       DefaultScopeName + ":" + levelToString[defaultOutputLevel],
		...
		{"--log-stacktrace-level warn", Options{
			OutputPaths:        []string{defaultOutputPath},
			ErrorOutputPaths:   []string{defaultErrorOutputPath},
			outputLevels:       DefaultScopeName + ":" + levelToString[defaultOutputLevel],
		...
		{"--log-stacktrace-level default:warn", Options{
			OutputPaths:        []string{defaultOutputPath},
			ErrorOutputPaths:   []string{defaultErrorOutputPath},
			outputLevels:       DefaultScopeName + ":" + levelToString[defaultOutputLevel],
		...
		{"--log-stacktrace-level error", Options{
			OutputPaths:        []string{defaultOutputPath},
			ErrorOutputPaths:   []string{defaultErrorOutputPath},
			outputLevels:       DefaultScopeName + ":" + levelToString[defaultOutputLevel],
		...
		{"--log-stacktrace-level default:error", Options{
			OutputPaths:        []string{defaultOutputPath},
			ErrorOutputPaths:   []string{defaultErrorOutputPath},
			outputLevels:       DefaultScopeName + ":" + levelToString[defaultOutputLevel],
		...
		{"--log-stacktrace-level none", Options{
			OutputPaths:        []string{defaultOutputPath},
			ErrorOutputPaths:   []string{defaultErrorOutputPath},
			outputLevels:       DefaultScopeName + ":" + levelToString[defaultOutputLevel],
		...
		{"--log-stacktrace-level default:none", Options{
			OutputPaths:        []string{defaultOutputPath},
			ErrorOutputPaths:   []string{defaultErrorOutputPath},
			outputLevels:       DefaultScopeName + ":" + levelToString[defaultOutputLevel],
		...
		{"--log-output-level debug", Options{
			OutputPaths:        []string{defaultOutputPath},
			ErrorOutputPaths:   []string{defaultErrorOutputPath},
		...
		{"--log-output-level error", Options{
			OutputPaths:        []string{defaultOutputPath},
			ErrorOutputPaths:   []string{defaultErrorOutputPath},
		...
		{"--log-rotate-max-age 1234", Options{
			OutputPaths:        []string{defaultOutputPath},
			ErrorOutputPaths:   []string{defaultErrorOutputPath},
			outputLevels:       DefaultScopeName + ":" + levelToString[defaultOutputLevel],
			stackTraceLevels:   DefaultScopeName + ":" + levelToString[defaultStackTraceLevel],
		...
		{"--log-rotate-max-size 1234", Options{
			OutputPaths:        []string{defaultOutputPath},
			ErrorOutputPaths:   []string{defaultErrorOutputPath},
			outputLevels:       DefaultScopeName + ":" + levelToString[defaultOutputLevel],
			stackTraceLevels:   DefaultScopeName + ":" + levelToString[defaultStackTraceLevel],
		...
		{"--log-rotate-max-backups 1234", Options{
			OutputPaths:        []string{defaultOutputPath},
			ErrorOutputPaths:   []string{defaultErrorOutputPath},
			outputLevels:       DefaultScopeName + ":" + levelToString[defaultOutputLevel],
			stackTraceLevels:   DefaultScopeName + ":" + levelToString[defaultStackTraceLevel],
